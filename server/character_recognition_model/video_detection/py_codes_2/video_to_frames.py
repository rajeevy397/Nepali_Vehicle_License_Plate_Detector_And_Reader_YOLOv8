...
if __name__ == "__main__":
    ...
    # video_path = r"C:\Users\Rajeev\Desktop\Major Project\Major Project Hepling tools Self made\Nepali_License\videos\c.mp4"  # Replace with the path to your video file
    PATH = os.path.join(
