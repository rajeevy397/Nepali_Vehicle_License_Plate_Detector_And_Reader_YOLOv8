...
INPUT_PATH = os.path.join('.', 'images', 'labels_output')
OUTPUT_PATH = os.path.join('.', 'images', 'frames_output') 
...
def write_characters_on_image(json_path, target_image_path, custom_font_path,output_folder):
...
if __name__ == "__main__":
    ...
    write_characters_on_image(json_path, target_image_path, custom_font_path,output_folder)
